        ...
        <div>
            <v-row justify="center">
                <v-col cols="12" sm="6" md="4" lg="3" xl="2">
                    <h1 class="page-title center" data-aos="flip-left" data-aos-duration="2000">Kawatayamuna</h1>
                </v-col>
            </v-row>
...
export default {
    ...
    data() {
        return {
            contentItems: [
                {
                    iframeSrc: "https://player.vimeo.com/video/1027618785?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
                ...
                {
                    iframeSrc: "https://momento360.com/e/u/6874362acd5148bc8e8e2b9f861f8ef5?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true",
                    subtitle: "Kawatayamuna - 360° Virtual Tour",
                    description: "Explore the Lush Vanilla Plantations and Scenic Beauty of Kawatayamuna in an Immersive 360° Experience.",
                },
                {
                    src: require("../assets/Images/kawatayamuna/KWT_Board.jpg"),
                ...
                {
                    src: require("../assets/Images/kawatayamuna/KWT_upView.jpg"),
                    subtitle: "Welcome to Kawatayamuna Vanilla Estate",
                    description: "Home of Premium Vanilla Cultivation - Experience Nature, Quality, and Sustainability.",
                },
                {
                    iframeSrc: "https://momento360.com/e/u/52b48a620c11467383803f991140aa92?utm_campaign=embed&utm_source=other&size=medium&display-plan=true",
                    subtitle: "Kawatayamuna - 360° Virtual Tour",
                    description: "Embark on a Virtual Journey Through the Verdant Vanilla Plantations and Breathtaking Scenery of Kawatayamuna in Stunning 360° Vision.",
                },
                {
                    src: "https://i.imghippo.com/files/PyQD4197lrs.jpg",
                    subtitle: "Dedication in Every Harvest",
                    description: "Hardworking Hands Cultivating Quality Vanilla for the World.",
                },
                {
                    src: "https://i.imghippo.com/files/DDw1268KE.jpg",
                    subtitle: "Nature's Finest Vanilla Blossoms",
                    description: "Growing with Care, Each Plant Represents Quality and Sustainability.",
                },
                {
                    src: "https://i.imghippo.com/files/ZEn2068bQc.jpg",
                    subtitle: "The Heart of Vanilla Cultivation",
                    description: "Our Skilled Team Nurturing Each Plant to Perfection.",
                },
                {
                    src: "https://i.imghippo.com/files/Hph6733JZ.jpg",
                    subtitle: "Nature's Finest Vanilla Blossoms",
                    description: "Growing with Care, Each Plant Represents Quality and Sustainability.",
                },
                {
                    src: "https://i.imghippo.com/files/Tef4201kbI.jpg",
                    subtitle: "Lush Green Vanilla Vines",
                    description: "Where Flavor Begins: The First Stages of Premium Vanilla Production.",
                },
                {
                    src: "https://i.imghippo.com/files/EIf9453mM.jpg",
                    subtitle: "Emerging Vanilla Splendor",
                    description: "The Journey from Green Vines to Aromatic Vanilla Begins Here.",
                },
                {
                    src: "https://i.imghippo.com/files/Hzm1195gZE.jpg",
                    subtitle: "Cultivating Excellence in Every Leaf",
                    description: "From Seedling to Harvest: A Tribute to Sustainable Vanilla Cultivation.",
                },         
            ],
